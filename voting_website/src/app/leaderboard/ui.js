...
function PodiumStep({ data, rank, h, order, spring }) {
  ...
  const podiumStyles = {
    1: { block: "from-[#facc15] via-[#a16207] to-[#1c1917]", border: "border-[#facc15]", glow: "shadow-[0_-15px_40px_rgba(234,179,8,0.4)]", emoji: "🥇", text: "text-[#eab308]", imgBorder: "border-[#facc15]" },
    2: { block: "from-[#a1a1aa] via-[#52525b] to-[#1c1917]", border: "border-[#a1a1aa]", glow: "shadow-[0_-10px_30px_rgba(161,161,170,0.3)]", emoji: "🥈", text: "text-[#a1a1aa]", imgBorder: "border-[#a1a1aa]" },
    3: { block: "from-[#b45309] via-[#7c2d12] to-[#1c1917]", border: "border-[#b45309]", glow: "shadow-[0_-8px_20px_rgba(180,83,9,0.25)]", emoji: "🥉", text: "text-[#b45309]", imgBorder: "border-[#b45309]" }
  }[rank];
